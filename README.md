...
Mede a qualidade geral dos dados enviados. Esse score considera problemas como:
...
- possíveis outliers;
- inconsistências textuais;
- possíveis dados pessoais ou sensíveis.

Problemas estruturais e alertas de privacidade têm maior impacto na nota.

### Aderência ao modelo recomendado

Mede o quanto a base se aproxima do modelo operacional sugerido no projeto.

Essa pontuação não significa que uma base de outro contexto esteja errada. Uma base de vendas, marketing, suporte, estoque ou RH pode ser válida mesmo sem colunas como centro de custo, tipo de custo ou unidade.

Por isso, a ausência de colunas recomendadas aparece como alerta, mas tem impacto menor no score de qualidade geral.
